### Wayle Configuration - General Settings

## General Configuration

settings-general-font-sans = Sans-Serif Font
    .description = Font family for UI text and labels

settings-general-font-mono = Monospace Font
